...
// }
  ...
  void get_name(List<dynamic> person_info) async {
    ...
    for (var i = 0; i < person_info.length; i++) {
      ...
      if (info.length != 0) {
        ...
        var url = Uri.https(
            endPoint, "/face/v1.0/persongroups/vox_lens/persons/" + personId);
  ...
  void registerFace(String name) async {
    ...
    if (res.length != 1) {
      ...
      var uri_name_reg =
          Uri.https(endPoint, "face/v1.0/persongroups/vox_lens/persons");
  ...
  void add_face(String personId, XFile? pickedImage) async {
    ...
    var uri = Uri.https(
        endPoint,
        "face/v1.0/persongroups/vox_lens/persons/" +
            personId +
            "/persistedFaces");
    var response = await http.post(
      uri,
